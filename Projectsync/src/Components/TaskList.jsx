        ...
        <div className="bg-white w-full md:w-2/6 flex justify-evenly rounded-md my-4 border-2 border-stone-400 shadow-2xl">
          ...
          <button
            className={`flex-grow py-2 font-semibold ${
              ...
              activeTab === "Done" ? "bg-black text-white" : "bg-transparent"
            }`}
        ...
        <table className="min-w-full bg-white">
          <thead>
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 border-b max-w-[200px]">
                Description
              </th>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 border-b">
                Created Date
                    ...
                    <Menu as="div" className="relative inline-block text-left">
                      ...
                      <Menu.Items className="absolute  right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div className="py-1 ">
                         ...
                         { userdata.is_permission && <Menu.Item>
                            {({ active }) => (
                              <button
                                onClick={() =>
                                  handleAction(
